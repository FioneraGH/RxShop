...
/**
 * GoodsDetailCommendedAdapter
 * Created by Victor on 15/12/1.
 */

public class GoodsDetailCommendedAdapter
        extends RecyclerView.Adapter<GoodsDetailCommendedAdapter.MyHolder> {
    private Context mContext;
    private List<GoodsDetailBean.ResultEntity.GoodsCommendlistEntity> goodsCommonList;

    public GoodsDetailCommendedAdapter(Context mContext,
                                       List<GoodsDetailBean.ResultEntity.GoodsCommendlistEntity>
                                               goodsCommonList) {
